...
- `turu feedback <kind>` — file a well-contexted GitHub issue (`bug`, `feature`, `question`, `chore`): redacted context bundle, optional `--from-last-error` scratch recall, `--dry-run` preview (via `genesis::feedback`)
